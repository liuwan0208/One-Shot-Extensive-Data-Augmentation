...
class Config:
    ...
    # hyperparameters
    # MODEL = "UNet_Pytorch_Simp2"
    # MODEL = "UNet_Pytorch_Simp1"
    MODEL = 'UNet_Pytorch'
    ...
    ##******need to change*****
    # LABELS_FILENAME = "bundle_masks_12"
    # CLASSES = 'Other_12'#"Other_60""Other_12w" ##"All"
    # NR_OF_CLASSES = len(dataset_specific_utils.# LABELS_FILENAME_P = 'bundle_masks_72_atlasfsl'
    #     # LABELS_FILENAME = "bundle_masks_72"  # autofilled(CLASSES)[1:])
    # TUNE_DATA = 'HCP' # for 'HCP'
    # # DATA_PATH = '/data4/wanliu/HCP_1.25mm_270/HCP_daug/Oneshot_845458/CutoutYChange'
    # # DATA_PATH = '/data4/wanliu/HCP_1.25mm_270/HCP_daug/Oneshot_845458/CutoutYKeep'
    # DATA_PATH = '/data4/wanliu/HCP_1.25mm_270/HCP_daug/Oneshot_845458/MtractoutYKeep'


    ##-----10 novel tracts-----
    #LABELS_FILENAME = "bundle_masks_4"
    #CLASSES = 'Other_4'
    #AUG_NUM = 15
    #NR_OF_CLASSES = len(dataset_specific_utils.get_bundle_names(CLASSES)[1:])
    #TUNE_DATA = 'TT'  # for 'TT'
    #DATA_PATH = '/data4/wanliu/HCP_2.5mm_341k/TT_daug/Oneshot_A05_6/CutoutYChange'
    ...
    AUG_NUM = 15
    TUNE_DATA = 'HCP'  # for 'HCP'
    DATA_PATH = '/data4/wanliu/HCP_2.5mm_341k/HCP_daug/Oneshot_683256_4/CutoutYKeep'
