...
class Config:
    ...
    # NR_OF_CLASSES = len(dataset_specific_utils.get_bundle_names(CLASSES)[1:])
    # AUG_NUM = 100
    # TUNE_DATA = 'TT'  # for 'HCP'
    # DATA_PATH = '/data6/wanliu/BT_1.7mm_270/TT_daug/Oneshot_A00_'+str(tract_num)+'/MtractoutYKeep'
    ...
    WEIGHTS_PATH = "/data6/wanliu/TractSeg_Run/hcp_exp9/my_custom_experiment_x6/best_weights_ep191.npz"
