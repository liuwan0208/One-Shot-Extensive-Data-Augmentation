...
class UNet_Pytorch_Simp1(torch.nn.Module):
    def __init__(self, n_input_channels=3, n_classes=7, n_filt=64, batchnorm=False, dropout=False,upsample="bilinear"):
        ...
        self.conv_6 = nn.Conv2d(n_classes, n_classes, kernel_size=1, stride=1, padding=0, bias=True)
    ...
    def forward(self, input):
        ...
        conv_5_seg = self.conv_5(expand_4_2_seg)
